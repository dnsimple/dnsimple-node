...
class Certificates {
   ...
   * @return {Promise}
   */
  letsencryptPurchaseRenewal(accountId, domainId, certificateId, options = {}) {
    return this._client.post(
   ...
   * @return {Promise}
   */
  letsencryptIssueRenewal(accountId, domainId, oldCertificateId, certificateRenewalId, options = {}) {
    return this._client.post(
