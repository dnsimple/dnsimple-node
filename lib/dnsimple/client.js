    ...
    return function(res) {
      ...
      res.on('end', function() {
        if (res.statusCode == 400) {
          ...
          reject.call(self, {description: 'Method not allowed'});
        } else if (res.statusCode == 429) {
          reject.call(self, {description: 'Too many requests'});
          ...
          try {
            reject.call(self, JSON.parse(data));
          } catch (e) {
            reject.call(self, e.message);
          }
        } else {
          reject.call(self, `Unsupported status code: ${res.statusCode}`);
        }
      });
    }
  }
