...
class Domains {
   ...
   * client.domains.listDomains(1010).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.listDomains(1010, {page: 2}).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.listDomains(1010, {sort: 'name:asc'}).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.listDomains(1010, {name_like: 'example'}).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.allDomains(1010).then((items) => {
   *   // use items
   * }, (error) => {
   *   // handle error
   * });
   *
   * @example List domains, provide a sorting policy
   * client.domains.allDomains(1010, {sort: 'name:asc'}).then((items) => {
   *   // use items
   * }, (error) => {
   *   // handle error
   * });
   *
   * @example List domains, provide a filtering policy
   * client.domains.allDomains(1010, {name_like: 'example'}).then((items) => {
   *   // use items
   * }, (error) => {
   *   // handle error
   * });
   ...
   * client.domains.listDelegationSignerRecords(1010, 'example.com').then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.listDelegationSignerRecords(1010, 'example.com', {page: 2}).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.listDelegationSignerRecords(1010, 'example.com', {sort: 'from:asc'}).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.allDelegationSignerRecords(1010, 'example.com').then((ds_records) => {
   ...
   * client.domains.allDelegationSignerRecords(1010, 'example.com', {sort: 'from:asc'}).then((ds_records) => {
   *   // use delegation signer record list
   * }, (error) => {
   *   // handle error
   * });
   ...
   * client.domains.listEmailForwards(1010, 'example.com').then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.listEmailForwards(1010, 'example.com', {page: 2}).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.listEmailForwards(1010, 'example.com', {sort: 'from:asc'}).then((response) => {
   *   # handle response
   * }, (error) => {
   *   # handle error
   * });
   ...
   * client.domains.allEmailForwards(1010, 'example.com').then((email_forwards) => {
   ...
   * client.domains.allEmailForwards(1010, 'example.com', {sort: 'from:asc'}).then((email_forwards) => {
   *   // use email forward list
   * }, (error) => {
   *   // handle error
   * });
