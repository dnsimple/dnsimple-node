...
describe('certificates', () => {
  describe('#listCertificates', () => {
    ...
    it('produces a certificate list', (done) => {
      ...
      dnsimple.certificates.listCertificates(accountId, domainId).then((response) => {
  ...
  describe('#allCertificates', () => {
    ...
    it('produces a complete list', (done) => {
      ...
      dnsimple.certificates.allCertificates(accountId, domainId).then((certificates) => {
  ...
  describe('#getCertificate', () => {
    ...
    it('produces a certificate', (done) => {
      ...
      dnsimple.certificates.getCertificate(accountId, domainId, certificateId).then((response) => {
    ...
    describe('when the certificate does not exist', () => {
      ...
      it('produces an error', (done) => {
        dnsimple.certificates.getCertificate(accountId, domainId, 0).then((response) => {
          done();
        }, (error) => {
  ...
  describe('#downloadCertificate', () => {
    ...
    it('produces a certificate', (done) => {
      ...
      dnsimple.certificates.downloadCertificate(accountId, domainId, certificateId).then((response) => {
        const certificate = response.data;
    ...
    describe('when the certificate does not exist', () => {
      ...
      it('produces an error', (done) => {
        dnsimple.certificates.downloadCertificate(accountId, domainId, 0).then((response) => {
          done();
        }, (error) => {
          expect(error).to.not.eq(null);
          done();
  ...
  describe('#getCertificatePrivateKey', () => {
    ...
    it('produces a certificate', (done) => {
      ...
      dnsimple.certificates.getCertificatePrivateKey(accountId, domainId, certificateId).then((response) => {
        const certificate = response.data;
    ...
    describe('when the certificate does not exist', () => {
      ...
      it('produces an error', (done) => {
        dnsimple.certificates.getCertificatePrivateKey(accountId, domainId, 0).then((response) => {
          done();
        }, (error) => {
          expect(error).to.not.eq(null);
          done();
  ...
  describe('#issueLetsencryptCertificate', () => {
    ...
    it('issues a certificate', (done) => {
      ...
      dnsimple.certificates.issueLetsencryptCertificate(accountId, domainId, certificateId).then((response) => {
        const certificate = response.data;
