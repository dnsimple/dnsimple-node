...
describe('domain delegation', () => {
  ...
  describe('#getDomainDelegation', () => {
    ...
    it('produces a name server list', (done) => {
      ...
      dnsimple.registrar.getDomainDelegation(accountId, domainId).then((response) => {
  ...
  describe('#changeDomainDelegation', () => {
    ...
    it('produces a name server list', (done) => {
      ...
      dnsimple.registrar.changeDomainDelegation(accountId, domainId, attributes).then((response) => {
        const delegation = response.data;
        expect(delegation).to.eql([
          'ns1.dnsimple.com',
          'ns2.dnsimple.com',
  ...
  describe('#changeDomainDelegationToVanity', () => {
    ...
    it('produces a name server list', (done) => {
      ...
      dnsimple.registrar.changeDomainDelegationToVanity(accountId, domainId, attributes).then((response) => {
        const delegation = response.data;
  ...
  describe('#changeDomainDelegationFromVanity', () => {
    it('produces nothing', (done) => {
      ...
      dnsimple.registrar.changeDomainDelegationFromVanity(accountId, domainId).then((response) => {
